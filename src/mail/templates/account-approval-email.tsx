...
export default function AccountApprovalEmail({ name, role }: AccountApprovalEmailProps) {
  return (
    <Html>
      <Head />
      <Tailwind>
          ...
          <Container className="mx-auto py-10 px-4">
            <Section className="bg-white rounded-2xl shadow-sm p-8 border border-gray-100 mt-8 mx-auto max-w-lg text-center">
              ...
              <Text className="text-base text-gray-600 mb-8 leading-relaxed">
                Hi {name}, congratulations! Your KYC documents have been reviewed and your {role} account is now fully approved.
